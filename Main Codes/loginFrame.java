   ...
   public loginFrame() {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
       String username = txtUsername.getText().trim();
        ...
        // Use DatabaseHelper instead of old logic
        UserAccount loggedInUser = DatabaseHelper.loginUser(username, password);

        if (loggedInUser != null) {
    Session.login(loggedInUser);   // ← Add this line
    ...
    switch (loggedInUser.role) {
        case 1: new userframexperi().setVisible(true); break;
        case 2: new OwnerFrame().setVisible(true); break;
        case 3: new AdminDashboard().setVisible(true); break;
        default: new startingScreen().setVisible(true);
    }
}
