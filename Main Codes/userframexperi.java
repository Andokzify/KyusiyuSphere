...
public class userframexperi extends JFrame {
    ...
    public userframexperi(UserAccount user) {
    ...
    private void addPlaceCard(Place place) {
        ...
        card.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) { new PlaceDetailDialog(userframexperi.this, place).setVisible(true); }
        });
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            ...
            if (!users.isEmpty()) new userframexperi(users.get(0)).setVisible(true);
