...
public class AddCiteDialog extends JDialog {
    ...
    private void uploadPhoto() {
        ...
        if (chooser.showOpenDialog(this) == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                ...
                // You can store the preview label if needed for later use
    ...
    private void saveCite(JTextField txtName, JTextField txtAddress, JTextField txtContact, JLabel preview) {
        ...
        // TODO: Save to DatabaseHelper later
        JOptionPane.showMessageDialog(this, 
            "New Cite Saved Successfully!\n\n" +
            "Name: " + name + "\n" +
            "Address: " + address + "\n" +
            "Contact: " + contact + "\n\n" +
            "Photo: " + (selectedImagePath.isEmpty() ? "None" : "Uploaded"));
