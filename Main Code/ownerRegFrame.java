...
public class ownerRegFrame extends javax.swing.JFrame {
    ...
    private void styleFormFields() {
        javax.swing.JComponent[] fields = {txtName, txtPassword, txtConfirm, txtContact, txtSiteName, txtEmail};
    ...
    private void styleErrorLabels() {
        javax.swing.JLabel[] errorLabels = {lblErrName, lblErrPassword, lblErrConfirm, lblErrContact, lblErrSiteName, lblErrEmail};
    ...
    private void initComponents() {
        ...
        lblErrSiteName = new javax.swing.JLabel();
        ...
        txtSiteName.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        ...
        txtSiteName.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                txtSiteNameKeyTyped(evt);
            }
        });
        getContentPane().add(txtSiteName);
        txtSiteName.setBounds(320, 570, 330, 40);
        ...
        lblErrPassword.setBounds(330, 400, 250, 30);
        ...
        getContentPane().add(lblErrSiteName);
        lblErrSiteName.setBounds(330, 610, 200, 30);
    ...
    private void btnRegisterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegisterActionPerformed
       clearAllErrors();
        ...
        if (password.isEmpty() || password.length() < 8) { setError(lblErrPassword, "! Password must be at least 8 characters."); hasError = true; }
        if (!password.equals(confirm)) { setError(lblErrConfirm, "! Passwords do not match."); hasError = true; }
        if (contact.isEmpty()) { setError(lblErrContact, "! Contact number is required."); hasError = true; }
        if (siteName.isEmpty()) { setError(lblErrSiteName, "! Site name is required."); hasError = true; }
        if (email.isEmpty()) { setError(lblErrEmail, "! Email is required."); hasError = true; }

        if (hasError) return;

        KyusiyuSphere.registerFromGUI(name, email, 0, password, 2, contact, siteName);
    ...
    private void txtSiteNameFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtSiteNameFocusGained
         txtSiteName.setBackground(new java.awt.Color(232, 236, 255));
    txtSiteName.setBorder(javax.swing.BorderFactory.createCompoundBorder(
        javax.swing.BorderFactory.createLineBorder(
            new java.awt.Color(60, 90, 200), 2),
        javax.swing.BorderFactory.createEmptyBorder(3, 8, 3, 8)
    ));
    ...
    private void txtSiteNameFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtSiteNameFocusLost
        txtSiteName.setBackground(new java.awt.Color(245, 246, 252));
    txtSiteName.setBorder(javax.swing.BorderFactory.createCompoundBorder(
        javax.swing.BorderFactory.createLineBorder(
            new java.awt.Color(150, 160, 195), 1),
        javax.swing.BorderFactory.createEmptyBorder(3, 8, 3, 8)
    ...
    private void txtSiteNameKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtSiteNameKeyTyped
        setError(lblErrSiteName, ""); // clears error as they type
    }//GEN-LAST:event_txtSiteNameKeyTyped
    ...
    private javax.swing.JLabel lblErrSiteName;
