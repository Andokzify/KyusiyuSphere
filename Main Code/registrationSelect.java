...
public class registrationSelect extends JFrame {
    ...
    private void initComponents() {
        ...
        // ================= ADMIN LINK =================
        JLabel adminLink = new JLabel("I am an Administrator →", SwingConstants.CENTER);
        adminLink.setFont(new Font("Courier New", Font.PLAIN, 16));
        adminLink.setForeground(new Color(20, 40, 140));
        adminLink.setBounds(420, 560, 300, 40);
        ...
        adminLink.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent e) {
                dispose();
                new adminRegFrame().setVisible(true);   // ← This connects adminRegFrame
            }
            public void mouseEntered(MouseEvent e) {
                adminLink.setForeground(new Color(30, 60, 180));
            }
            public void mouseExited(MouseEvent e) {
                adminLink.setForeground(new Color(20, 40, 140));
            }
