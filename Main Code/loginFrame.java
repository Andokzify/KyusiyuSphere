...
public class loginFrame extends javax.swing.JFrame {
   ...
   public loginFrame() {
    ...
    private UserAccount attemptLogin(String name, String pass) {
        if (KyusiyuSphere.users.isEmpty()) {
            return null;
        }

        for (UserAccount u : KyusiyuSphere.users) {
            if (u.name.equals(name) && u.password.equals(pass)) {
                return u;   // Return the full user object
            }
        }
        return null;
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("QCU Practice Space & Activity Locator");
        jPanel1.add(jLabel2);
        jLabel2.setBounds(390, 200, 230, 18);
    ...
    String username = txtUsername.getText().trim();
        ...
        UserAccount loggedInUser = attemptLogin(username, password);
        ...
        if (loggedInUser != null) {
            ...
            switch (loggedInUser.role) {
                case 1:  // Student
                    new userframexperi().setVisible(true);      // Change to your student dashboard later
                    break;
                case 2:  // Owner
                    new startingScreen().setVisible(true);     // Change to your owner dashboard later
                    break;
                case 3:  // Admin
                    new adminRegFrame().setVisible(true);  // Temporary - you can make a proper AdminFrame later
                    break;
                default:
